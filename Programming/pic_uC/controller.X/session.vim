...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 32 + 67) / 135)
exe 'vert 2resize ' . ((&columns * 102 + 67) / 135)
argglobal
balt terminal.h
let s:cpo_save=&cpo
set cpo&vim
...
47
normal! zo
let s:l = 35 - ((1 * winheight(0) + 15) / 31)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 46 - ((12 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 46
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 34 - ((6 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 34
...
badd +9 cpu_map.h
badd +28 fuses.h
badd +7 comparators.h
badd +13 comparators.c
badd +7 uart.h
badd +126 uart.c
badd +2 protocol.h
badd +12 protocol.c
