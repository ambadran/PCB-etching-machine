...
exe 'vert 3resize ' . ((&columns * 60 + 67) / 135)
exe '4resize ' . ((&lines * 21 + 17) / 34)
exe 'vert 4resize ' . ((&columns * 106 + 67) / 135)
argglobal
balt pid.h
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists("heater.c") | buffer heater.c | else | edit heater.c | endif
balt terminal.c
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
exe 'vert 2resize ' . ((&columns * 63 + 67) / 135)
...
wincmd w
argglobal
if bufexists("interrupts.c") | buffer interrupts.c | else | edit interrupts.c | endif
balt cpu_map.h
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
