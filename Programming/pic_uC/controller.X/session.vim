...
36
normal! zo
let s:l = 60 - ((13 * winheight(0) + 15) / 31)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 36 - ((14 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 36
...
31
normal! zo
let s:l = 174 - ((16 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 174
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 29 - ((11 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 29
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 17 - ((2 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 17
