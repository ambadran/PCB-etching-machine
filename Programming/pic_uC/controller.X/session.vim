...
36
normal! zo
let s:l = 23 - ((16 * winheight(0) + 15) / 31)
...
161
normal! zo
let s:l = 74 - ((13 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 74
...
exe '2resize ' . ((&lines * 21 + 17) / 34)
tabnext
edit ~/electronics/PIC/UART/pic18f45k22/UART.h
argglobal
balt cpp_module.h
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 102 - ((30 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 102
...
badd +1 ~/Projects/PCB-etching-machine/Programming/pic_uC/controller.X/uart.h
badd +74 ~/Projects/PCB-etching-machine/Programming/pic_uC/controller.X/uart.c
