...
badd +10 protocol_.h
badd +56 protocol_.c
badd +17 cpp_module_.h
badd +80 cpp_module_.c
badd +7 nuts_bolts_.h
badd +13 nuts_bolts_.c
badd +0 testing/test6.c
badd +9 includes.h
argglobal
%argdel
$argadd main.c
...
exe '3resize ' . ((&lines * 9 + 22) / 45)
exe 'vert 3resize ' . ((&columns * 74 + 79) / 158)
exe '4resize ' . ((&lines * 32 + 22) / 45)
exe 'vert 4resize ' . ((&columns * 127 + 79) / 158)
argglobal
balt includes.h
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let &fdl = &fdl
let s:l = 44 - ((36 * winheight(0) + 21) / 42)
...
wincmd w
argglobal
if bufexists(fnamemodify("thermistor.c", ":p")) | buffer thermistor.c | else | edit thermistor.c | endif
balt terminal.h
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
wincmd w
argglobal
if bufexists(fnamemodify("terminal.h", ":p")) | buffer terminal.h | else | edit terminal.h | endif
balt thermistor.c
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
wincmd w
argglobal
if bufexists(fnamemodify("terminal.c", ":p")) | buffer terminal.c | else | edit terminal.c | endif
balt thermistor.c
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
wincmd w
argglobal
if bufexists(fnamemodify("uart.c", ":p")) | buffer uart.c | else | edit uart.c | endif
balt uart.h
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
silent! normal! zE
let &fdl = &fdl
let s:l = 104 - ((31 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 104
...
wincmd w
argglobal
if bufexists(fnamemodify("protocol.c", ":p")) | buffer protocol.c | else | edit protocol.c | endif
balt protocol_.c
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
silent! normal! zE
let &fdl = &fdl
let s:l = 42 - ((17 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 42
...
wincmd w
argglobal
if bufexists(fnamemodify("cpp_module.c", ":p")) | buffer cpp_module.c | else | edit cpp_module.c | endif
balt cpp_module_.c
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
wincmd w
argglobal
if bufexists(fnamemodify("nuts_bolts.c", ":p")) | buffer nuts_bolts.c | else | edit nuts_bolts.c | endif
balt nuts_bolts_.c
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
