...
silent only
silent tabonly
cd ~/Projects/PCB-etching-machine/Programming/pic_uC/controller.X
...
exe 'vert 2resize ' . ((&columns * 44 + 67) / 135)
exe '3resize ' . ((&lines * 9 + 17) / 34)
exe 'vert 3resize ' . ((&columns * 59 + 67) / 135)
exe '4resize ' . ((&lines * 21 + 17) / 34)
...
let s:l = 29 - ((21 * winheight(0) + 15) / 31)
...
wincmd w
argglobal
if bufexists("thermistor.h") | buffer thermistor.h | else | edit thermistor.h | endif
balt terminal.h
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
wincmd w
argglobal
if bufexists("terminal.h") | buffer terminal.h | else | edit terminal.h | endif
balt thermistor.h
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
wincmd w
argglobal
if bufexists("terminal.c") | buffer terminal.c | else | edit terminal.c | endif
balt terminal.h
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
78
normal! zo
let s:l = 72 - ((9 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 72
...
35
normal! zo
let s:l = 15 - ((6 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 15
...
wincmd w
argglobal
if bufexists("nuts_bolts.c") | buffer nuts_bolts.c | else | edit nuts_bolts.c | endif
balt nuts_bolts.h
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
14
normal! zc
let s:l = 104 - ((103 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 104
...
168
normal! zo
let s:l = 48 - ((33 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 48
...
wincmd w
argglobal
if bufexists("cpp_module.c") | buffer cpp_module.c | else | edit cpp_module.c | endif
balt cpp_module.h
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 25 - ((16 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 25
...
wincmd w
argglobal
if bufexists("fuses.h") | buffer fuses.h | else | edit fuses.h | endif
balt interrupts.c
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
wincmd w
argglobal
if bufexists("includes.h") | buffer includes.h | else | edit includes.h | endif
balt interrupts.c
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
wincmd w
argglobal
if bufexists("timers.c") | buffer timers.c | else | edit timers.c | endif
balt timers.h
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 10 - ((3 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 10
...
badd +14 includes.h
badd +1 timers.c
badd +1 ~/electronics/PIC/UART/pic18f45k22/UART.h
badd +2 testing/test.c
badd +1 cpp.h
badd +1 ~/electronics/PIC/UART
badd +2 uart.h.gch
badd +5 interrupts.h
badd +6 debugger.h
badd +1 debugger.c
