...
silent only
silent tabonly
cd ~/Projects/PCB-etching-machine/Programming/pic_uC/controller_old.X
...
exe 'vert 3resize ' . ((&columns * 102 + 67) / 135)
argglobal
balt uart.h
let s:cpo_save=&cpo
set cpo&vim
...
59
normal! zo
let s:l = 66 - ((1 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 66
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 60 - ((21 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 60
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 77 - ((6 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 77
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 39 - ((14 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 39
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 22 - ((14 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 22
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 73 - ((14 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 73
