...
silent only
silent tabonly
cd ~/Projects/PCB-etching-machine/Programming/monitor_pic
...
badd +0 monitor.py
badd +0 ../micropython/pid_controller.py
badd +0 serial_monitor.py
argglobal
%argdel
$argadd monitor.py
set stal=2
...
normal! 0
tabnext
edit serial_monitor.py
argglobal
balt ../micropython/pid_controller.py
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
normal! 0
tabnext
edit ../micropython/pid_controller.py
argglobal
balt monitor.py
let s:cpo_save=&cpo
set cpo&vim
